...
public class ItemBlockSolars extends ItemBlock {
    ...
    public String getUnlocalizedName(ItemStack itemstack) {
        ...
        final String unlocalizedName = "tile." + EMT.MOD_ID
                + "."
                + Solars.getUnlocalizedName(this.instance, itemstack.getItemDamage());
                    ...
                    case 12: { // fire
                        ...
                        list.add(
                                EMTTextHelper.BRIGHT_GREEN + localize("tooltip.EMT.specialEffect")
                                        + ": "
                                        + EMTTextHelper.LIGHT_GRAY
                                        + localize("tooltip.EMT.output.triple")
                                        + " "
                        ...
                        list.add(
                                EMTTextHelper.BRIGHT_GREEN + localize("tooltip.EMT.specialEffect")
                                        + ": "
                                        + EMTTextHelper.LIGHT_GRAY
                                        + localize("tooltip.EMT.output.double")
                                        + " "
                    ...
                    case 15: { // aer
                        ...
                        list.add(
                                EMTTextHelper.BRIGHT_GREEN + localize("tooltip.EMT.specialEffect")
                                        + ": "
                                        + EMTTextHelper.LIGHT_GRAY
                                        + localize("tooltip.EMT.output.double.half.height"));
                        break;
                    }
                    default: {
                    ...
                    case 2: { // terra
                        ...
                        list.add(
                                EMTTextHelper.BRIGHT_GREEN + localize("tooltip.EMT.specialEffect")
                                        + ": "
                                        + EMTTextHelper.LIGHT_GRAY
                                        + localize("tooltip.EMT.output.double.half.low"));
                        break;
                    }
                    case 3: {
                        list.add(
